...
const Features = () => {
  ...
  const features = [
    {
      ...
      description:
        "Gather user feedback and upvotes. Know what to build next. Let users submit feedback or upvote on posts on your own personalized boards.",
      image: <FeedbackBoard />,
      reversed: false,
    },
    {
      ...
      description:
        "Collect user feedback from everywhere. Embed it on your website, within your product, or anywhere you want! Users can describe problems with screenshots and more.",
    ...
    },
    {
      ...
      description:
        "Share your progress in one single overview. Show users what you're working on and what they can expect next. Keep them informed about every step of your development process.",
    ...
    },
    {
      title: "Changelog",
      description:
        "Share all of your releases and updates in one single overview. Instantly notify users when new releases are added to the Changelog and keep them engaged with your product journey.",
      image: (
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Detects when someone is speaking complete nonsense to
                    automatically roll your eyes, even when you're trying to be
                    polite.
                  </p>
                </div>
  ...
  return (
    <section
      id="features"
      className="section-container bg-marketing-background"
    >
      <div className="text-center mb-16 animate-on-scroll">
        <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 relative inline-block">
          ...
          <svg
            className="absolute -right-10 -top-10 w-24 h-24 opacity-20 text-floopr-purple"
            viewBox="0 0 100 100"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
      ...
      <div className="space-y-20 px-[40px]">
      ...
      <div className="mt-24 text-center">
        <h2 className="text-4xl md:text-5xl font-bold mb-12 relative inline-block">
          <ScribbleHighlight>
            Literally, all the features you need!
          </ScribbleHighlight>
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <div className="glass-card p-8 text-center">
            <div className="w-12 h-12 rounded-full bg-floopr-purple-bg flex items-center justify-center mb-4 mx-auto">
              <svg
                className="h-6 w-6 text-floopr-purple"
                viewBox="0 0 24 24"
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
              >
            ...
            <p className="text-black">
              Let your users, your team or any stakeholders upvote on posts.
            </p>
          </div>
          ...
          <div className="glass-card p-8 text-center">
            <div className="w-12 h-12 rounded-full bg-floopr-purple-bg flex items-center justify-center mb-4 mx-auto">
              ...
              >
                <path
                  d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L9 19l-1-1-1-1 4.257-4.257A6 6 0 1119 9z"
                  stroke="currentColor"
                  strokeWidth="2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <p className="text-black">
              Automatically authenticate your users and give them access.
            </p>
          </div>
          ...
          <div className="glass-card p-8 text-center">
            ...
            <p className="text-black">
              Approve new posts and/or comments first.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 flex justify-center">
          <Link
            href="#cta"
            className="bg-floopr-purple hover:bg-floopr-purple-dark font-medium px-8 py-3 rounded-full transition-all transform hover:scale-105"
          >
            Get Started Today
          </Link>
        </div>
