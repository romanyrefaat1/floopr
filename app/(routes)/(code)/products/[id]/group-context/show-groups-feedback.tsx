      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        {Object.entries(groupedFeedback).map(([groupId, feedbackIds]) => {
          ...
          return (
            ...
            >
              <AccordionTrigger className="flex flex-col items-start px-4 sm:px-6 py-4 bg-background hover:bg-mutedBackground transition-colors duration-200 [&[data-state=open]]:bg-muted/80">
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end" className="w-48">
                            ...
                            >
                              ...
                              {deletingGroup === groupId ? "Deleting..." : "Delete"}
                            </DropdownMenuItem>
                          </DropdownMenuContent>
                        </DropdownMenu>
                      </>
              ...
              <AccordionContent className="px-4 sm:px-6 pt-2 pb-6 bg-background">
                {loading ? (
                  Array(3)
                    .fill(0)
                    .map((_, idx) => (
