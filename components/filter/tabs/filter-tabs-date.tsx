  ...
  return (
    <div className="w-full">
      <div className="w-full">
        <DropdownMenu>
          <DropdownMenuTrigger>
            <Button variant={`outline`}>Filter By Range</Button>
          </DropdownMenuTrigger>
          <DropdownMenuContent>
            ...
            <DropdownMenuRadioGroup>
              <DropdownMenuRadioItem
                value="24 hours"
                onClick={() => handleQuickCLick(`24-hours`)}
              >
                24 hours
              </DropdownMenuRadioItem>
              <DropdownMenuRadioItem
                value="7 days"
                onClick={() => handleQuickCLick(`7-days`)}
              >
                7 days
              </DropdownMenuRadioItem>
              <DropdownMenuRadioItem
                value="30 days"
                onClick={() => handleQuickCLick(`30-days`)}
              >
                30 days
              </DropdownMenuRadioItem>
            </DropdownMenuRadioGroup>
      ...
      <div className="w-full">
        ...
        />
        <Button onClick={handleSpecialDateClick} variant={`outline`}>
          Apply
        </Button>
      </div>
    </div>
