...
export default function FloatingFeedbackButton({
  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      ...
      >
        <span className="relative z-10 transition-transform duration-300 group-hover:-translate-y-px text-white">
          💭
        </span>
      </button>
      ...
      {isOpen && (
        <div
          ...
          style={{ backgroundColor: isModal ? overlayColor : "transparent" }}
        >
          <div
            className={cn(
              ...
              >
                {!selectedType ? (
                  ...
                  <div
                    ...
                    style={{
                      ...(getSecondSectionStyles() as React.CSSProperties),
                  ...
                  >
                    ...
                    <Button
                      ...
                      style={{
                        ...
                        boxShadow: "0 0 12px var(--button-glow)",
                        color: "white",
                        borderRadius: borderRadiusSizes[borderRadius],
                      }}
                    >
